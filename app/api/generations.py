...
from app.api.schemas import ImageGenerationRequest, OmniVideoGenerationRequest, VideoGenerationRequest
...
@router.post("/v1/images/generations",status_code=202)
...
@router.post("/v1/videos/generations",status_code=202)
...
@router.post("/v1/videos/omni-generations",status_code=202)
