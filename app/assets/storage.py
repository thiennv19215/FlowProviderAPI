...
class LocalStorage:
    ...
    def presign_get(self,key:str,ttl:int)->str|None:return None
    def presign_put(self,key:str,content_type:str,ttl:int)->str|None:return None
...
class R2Storage:
    ...
    def presign_put(self,key:str,content_type:str,ttl:int)->str:return self.client.generate_presigned_url("put_object",Params={"Bucket":self.bucket,"Key":key,"ContentType":content_type},ExpiresIn=ttl,HttpMethod="PUT")


def build_storage(settings):return R2Storage(settings) if settings.storage_backend=="r2" else LocalStorage(settings.local_storage_path)
