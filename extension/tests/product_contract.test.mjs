...
test('release zip is generated by CI instead of being checked into extension source', () => {
  assert.equal(fs.existsSync(new URL('../extension.zip', import.meta.url)), false);
});
